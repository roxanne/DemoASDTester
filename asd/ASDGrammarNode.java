...
   /* mutator methods to be used by the ASDGrammarEditor and
   ...
   public void setBegins(boolean begins)
      { nodeBegins = begins; }
  public void setBeginsTypes(ArrayList<String> beginsTypes)
      { nodeBeginsTypes = beginsTypes; }
  ...
  public void setSemanticValue(String semanticValue)
      { nodeSemanticValue = semanticValue; }
   public void setSuccessors(ArrayList<ASDGrammarSuccessor> successors)
      { nodeSuccessors = successors; }
   public void setSuccessorTypes(ArrayList<String> successorTypes)
      { nodeSuccessorTypes = successorTypes; }
